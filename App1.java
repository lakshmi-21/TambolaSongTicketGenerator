...
public class App1 {
	 ...
	 * @param args
	 */
	public static void main(List<String> filename) {
		...
		for (int i = 0; i < filename.size(); i++) {
			Node currTicket = nodes[i];
            String[][] songArray = new String[3][9];
			for (int r = 0; r < 3; r++) {
				for (int col = 0; col < 9; col++) {
					...
					if (num != 0)
                    {
                        ...
                        songArray[r][col]=generateTickets.hm_songs.get(num);//added now
                    }
            ...
            generateTickets.printToExcel(songArray,filename.get(i)); //added now
